...
positive_words = {"good", "great", "amazing", "enjoyable", "nice", "fantastic", "love", "excellent", "wonderful", "best"}
negative_words = {"bad", "worst", "boring", "terrible", "awful", "poor", "hate", "2nd grade", "waste", "disappointing"}
pronouns = {"i", "me", "my", "you", "your"}  # all lowercase
...
print("\nFeature values:")
print(f"x1 (Positive words): {x1}")
print(f"x2 (Negative words): {x2}")
print(f"x3 (Contains 'no'): {x3}")
print(f"x4 (Pronoun counts): {x4}")
print(f"x5 (Exclamation marks): {x5}")
print(f"x6 (Total words): {x6}")
